...
void wk_usart2_init(void)
{
  ...
  /* configure the TX pin */
  gpio_pin_mux_config(USART2_TX_PA8_GPIO_PORT, GPIO_PINS_SOURCE8, GPIO_MUX_8);
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_MODERATE;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
  ...
  /* configure the RX pin */
  gpio_pin_mux_config(USART2_RX_PB0_GPIO_PORT, GPIO_PINS_SOURCE0, GPIO_MUX_6);
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_MODERATE;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
  gpio_init_struct.gpio_pins = USART2_RX_PB0_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_UP;
  gpio_init(USART2_RX_PB0_GPIO_PORT, &gpio_init_struct);
...
void wk_usart3_init(void)
{
  ...
  /* configure the TX pin */
  gpio_pin_mux_config(TTS_TX_PB10_GPIO_PORT, GPIO_PINS_SOURCE10, GPIO_MUX_7);
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_MODERATE;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
  ...
  /* configure the RX pin */
  gpio_pin_mux_config(TTS_RX_PB11_GPIO_PORT, GPIO_PINS_SOURCE11, GPIO_MUX_7);
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_MODERATE;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
  gpio_init_struct.gpio_pins = TTS_RX_PB11_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_UP;
  gpio_init(TTS_RX_PB11_GPIO_PORT, &gpio_init_struct);
...
void wk_uart5_init(void)
{
  ...
  /* configure the TX pin */
  gpio_pin_mux_config(UART5_LOG_TX_PE10_GPIO_PORT, GPIO_PINS_SOURCE10, GPIO_MUX_8);
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_MODERATE;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
  ...
  /* configure the RX pin */
  gpio_pin_mux_config(UART5_LOG_RX_PE11_GPIO_PORT, GPIO_PINS_SOURCE11, GPIO_MUX_8);
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_MODERATE;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
  gpio_init_struct.gpio_pins = UART5_LOG_RX_PE11_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_UP;
  gpio_init(UART5_LOG_RX_PE11_GPIO_PORT, &gpio_init_struct);
