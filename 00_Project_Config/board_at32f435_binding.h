...
#define BOARD_GPIO_RS485_DIR_PORT         RS485_RXEN_PA12_GPIO_PORT
#define BOARD_GPIO_RS485_DIR_PIN          RS485_RXEN_PA12_PIN
...
#define BOARD_UART_REMOTE_4G_INSTANCE          USART2
#define BOARD_UART_REMOTE_4G_RX_DMA            DMA1_CHANNEL1
#define BOARD_UART_REMOTE_4G_RX_DMA_GLOBAL     DMA1_GL1_FLAG
#define BOARD_UART_REMOTE_4G_RX_DMA_HALF       DMA1_HDT1_FLAG
#define BOARD_UART_REMOTE_4G_RX_DMA_FULL       DMA1_FDT1_FLAG
#define BOARD_UART_REMOTE_4G_RX_DMA_ERROR      DMA1_DTERR1_FLAG

#define BOARD_UART_RS485_INSTANCE             USART1
#define BOARD_UART_RS485_RX_DMA               DMA1_CHANNEL2
#define BOARD_UART_RS485_RX_DMA_GLOBAL        DMA1_GL2_FLAG
#define BOARD_UART_RS485_RX_DMA_HALF          DMA1_HDT2_FLAG
#define BOARD_UART_RS485_RX_DMA_FULL          DMA1_FDT2_FLAG
#define BOARD_UART_RS485_RX_DMA_ERROR         DMA1_DTERR2_FLAG

#define BOARD_UART_VTX316_INSTANCE            USART3
#define BOARD_UART_VTX316_RX_DMA              DMA1_CHANNEL3
#define BOARD_UART_VTX316_RX_DMA_GLOBAL       DMA1_GL3_FLAG
#define BOARD_UART_VTX316_RX_DMA_HALF         DMA1_HDT3_FLAG
#define BOARD_UART_VTX316_RX_DMA_FULL         DMA1_FDT3_FLAG
#define BOARD_UART_VTX316_RX_DMA_ERROR        DMA1_DTERR3_FLAG

#define BOARD_I2S_AUDIO_OUTPUT_INSTANCE       SPI1
#define BOARD_I2S_AUDIO_OUTPUT_TX_DMA         EDMA_STREAM1
#define BOARD_I2S_AUDIO_OUTPUT_TX_DMA_HALF    EDMA_HDT1_FLAG
